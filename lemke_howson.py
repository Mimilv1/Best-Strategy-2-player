...
#https://quanteconpy.readthedocs.io/en/latest/_modules/quantecon/game_theory/lemke_howson.html#lemke_howson
#https://quanteconpy.readthedocs.io/en/latest/game_theory/lemke_howson.html
"""
...
"""
Utilite pour calculer les probabilite de coup du joueur 1 dans le cas ou la distance entre le joueur 1 et le joueur 2 est inferieur ou egale a 4
On a 41 strategie pur pour le joueur 1
et entre 41 et 18 pour le joueur 1
"""
...
def bimat(mat1, mat2) :
    ...
    for i in range(len(mat1)):
        mat3.append([(mat1[i][j],mat2[i][j]) for j in range(len(mat[i]))])
    return mat3
mat = bimat(G1(1,[0,0],[0,4]),G2(1,[0,0],[0,4]))
print(mat)

g = NormalForGame(mat)

NE, re = lemke_howson(g, init_pivot=1, full_output=True)
print(NE)
print(re.converged)
print(re.num_iter)
print(g)
